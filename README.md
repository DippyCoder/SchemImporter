...
Is a Minecraft plugin for [PaperMC](https://papermc.io/downloads/paper) that allows importing schematics from download URLs into the FAWE schematics folder.
